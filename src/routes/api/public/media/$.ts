/**
 * Public image proxy for operator-uploaded listing/storefront media.
 *
 * Uploads land in the private `business-media` bucket under
 * `<businessId>/public/<file>`. Only that `public/` prefix is served here, so
 * anything else an operator stores in the bucket stays private.
 */
